...
💡 Tecnologias que estudo: Java, Spring Boot, PostgreSQL, React, TypeScript.
🚀 Atualmente desenvolvo um sistema fullstack de gerenciamento de biblioteca escolar, aplicando meus conhecimentos de back-end e front-end.
🎤 Também sou palestrante — já apresentei meus projetos e métodos de estudo para diferentes públicos.
...
**[Gerenciador de Biblioteca](https://github.com/sandersonElias/Gerenciador_Biblioteca)** — Sistema fullstack de gerenciamento de biblioteca escolar.
- Back-end: [Java + Spring Boot](https://github.com/sandersonElias/Back-End_GerenciadorBiblioteca)
- Front-end: [React + TypeScript](https://github.com/sandersonElias/Front-End_GerenciadorBiblioteca)
- Banco: PostgreSQL
